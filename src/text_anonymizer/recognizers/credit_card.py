...
class CustomCreditCardRecognizer(CreditCardRecognizer, CustomRecognizerMixin):
    """
    Recognize credit card entities using Presidio´s pre-defined recognizer.
    """

    POSSIBLE_LANGUAGES = None
    POSSIBLE_ENTITIES = [constants.ENTITY_CREDIT_CARD]
    POSSIBLE_REGIONS = constants.VALID_GLOBALLY

    def __init__(self, supported_language, supported_entities, supported_regions):
        CreditCardRecognizer.__init__(
            self,
