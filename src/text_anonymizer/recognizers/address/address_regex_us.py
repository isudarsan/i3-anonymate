# -*- coding: utf-8 -*-
"""
    Taken from python library pyap https://github.com/vladimarius/pyap/blob/master/pyap/source_US/data.py
...
street_number = r"""(?P<street_number>
                ...
                """.format(
    thousand=thousand, hundred=hundred, zero_to_nine=zero_to_nine, ten_to_ninety=ten_to_ninety, from_to="{1,5}"
)
